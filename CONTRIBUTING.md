...
```
feat: add QR decomposition C ABI
fix(c_api): clamp negative index instead of raising
docs: clarify the Cholesky SPD-failure contract
...
indices/lengths itself and returns a sentinel or `ULIN_ERR_*` code, never raises.
